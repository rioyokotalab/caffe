...
void SoftmaxLayer<Dtype,Mtype>::Reshape(const vector<Blob<Dtype,Mtype>*>& bottom,
  ...
  caffe_set<Dtype,Mtype>(sum_multiplier_.count(), Mtype(1), multiplier_data);
...
template <typename Dtype, typename Mtype>
void SoftmaxLayer<Dtype,Mtype>::Forward_cpu(const vector<Blob<Dtype,Mtype>*>& bottom,
    const vector<Blob<Dtype,Mtype>*>& top) {
...
template <typename Dtype, typename Mtype>
void SoftmaxLayer<Dtype,Mtype>::Backward_cpu(const vector<Blob<Dtype,Mtype>*>& top,
